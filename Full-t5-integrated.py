...
def summarize_text(text):
    ...
    model_name = "t5-small"  # You can choose a different model if desired
...
def main():
    ...
    """
    if len(sys.argv) != 2:
        print("Usage: python image_text_processor.py <path_to_image>")
        sys.exit(1)
...
# python -u "E:\My_Projects\Doc_Analyzer\Full-t5-integrated.py" "E:\My_Projects\Doc_Analyzer\agreement.jpg"
