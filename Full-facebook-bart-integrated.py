...
def summarize_text(text):
    """
    Summarize the input text using the pre-trained BART model.
    ...
    model_name = "facebook/bart-large-cnn"  # Updated model
...
def main():
    ...
    """
    if len(sys.argv) != 2:
        print("Usage: python image_text_processor_bart.py <path_to_image>")
        sys.exit(1)
...
# python -u "E:\My_Projects\Doc_Analyzer\Full-facebook-bart-integrated.py" "E:\My_Projects\Doc_Analyzer\agreement.jpg"